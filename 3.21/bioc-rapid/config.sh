#!/bin/bash
# ============================================================================
# Settings shared by all the Unix nodes involved in the 3.21-bioc-rapid builds
# ============================================================================


export BBS_BUILDTYPE="bioc-rapid"
...
export BBS_BIOC_MANIFEST_GIT_BRANCH="devel"
...
export BBS_MEAT0_RDIR="/home/rapidbuild/bbs-3.21-bioc-rapid/MEAT0"
