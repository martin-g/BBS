@rem ===============================================================================
@rem Settings shared by all the Windows nodes involved in the 3.21-bioc-rapid builds
@rem ===============================================================================


set BBS_BUILDTYPE=bioc-rapid
...
set BBS_MEAT0_RDIR=/home/rapidbuild/bbs-3.21-bioc-rapid/MEAT0
