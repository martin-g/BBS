...
dnf install -y firefox graphviz graphviz-devel gtkmm24-devel gsl-devel automake netcdf-devel eigen3-devel fribidi-devel fuse fuse-devel rsync ffmpeg-devel ocl-icd-devel minimap2 libatomic tbb-devel xorg-x11-server-Xvfb.aarch64
