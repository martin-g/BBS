...
dnf install -y firefox graphviz graphviz-devel gtkmm24-devel gsl-devel automake netcdf-devel eigen3-devel fribidi-devel fuse fuse-devel rsync ffmpeg-devel openbabel-devel ocl-icd-devel minimap2 libatomic gcc-toolset-12-libstdc++
