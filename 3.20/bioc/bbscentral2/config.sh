...
# Control propagation:
export BBS_OUTGOING_MAP="source:teran2/buildsrc win.binary:palomino8/buildbin mac.binary.big-sur-x86_64:lconway/buildbin mac.binary.big-sur-arm64:kjohnson3/buildbin"
export BBS_FINAL_REPO="file://home/biocpush/PACKAGES/$BBS_BIOC_VERSION/bioc"

# Control generation of the report:
export BBS_REPORT_NODES="teran2 nebbiolo2 palomino8:bin lconway:bin kjohnson3:bin kunpeng2"
