...
# Control propagation:
export BBS_OUTGOING_MAP="source:nebbiolo2/buildsrc win.binary:palomino8/buildbin mac.binary.big-sur-x86_64:merida1/buildbin mac.binary.big-sur-arm64:kjohnson1/buildbin"
export BBS_FINAL_REPO="file://home/biocpush/PACKAGES/$BBS_BIOC_VERSION/bioc"

# Control generation of the report:
export BBS_REPORT_NODES="nebbiolo2 palomino8:bin merida1:bin kjohnson1:bin"
