...
LOCAL_REPO_ROOT="$HOME/PACKAGES/3.21/data/annotation"
REMOTE_REPO_ROOT="/extra/www/bioc/packages/3.21/data/annotation"
PKG_FILEPATHS="src/contrib/*.tar.gz bin/windows/contrib/4.5/*.zip bin/macosx/big-sur-x86_64/contrib/4.5/*.tgz"
CONTRIB_DIR=" \/.*\/"
